 ...
 *  this bundle actually pulls in): dsh-session's surface predicate (the
 *  inlined set is the 0.1.5-rc.1 one; no behavior change here — the only call
 *  site filters `tool/result`), dsh-brand
