	...
	factory: (require) => {
		...
		function applyUpdateState(state, match) {
			...
			if (dispatch !== null) {
				...
				const dedupeKey = String(data["rootCallId"]) + "\0" + String(data["subCallId"]);
