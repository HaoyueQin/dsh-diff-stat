window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		function whenGlassReady(timeoutMs = 1e4) {
		...
		function MutationRow({ toolName, block, cwd, openFile, inspect }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [status !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					...
					collapsedContent: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(react_jsx_runtime.Fragment, { children: (summaryText !== "" || stats !== null) && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
						...
						fileLink ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							type: "button",
							className: clsx(ToolRow_module_css_default.fileLink, badge_module_css_default.linkFit),
					...
					children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [diffBody !== null ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(DiffWindow, {
		...
		*/
		...
		function EyeIcon({ size = 13 }) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
				...
				strokeWidth: "1.3",
				"aria-hidden": "true",
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M1.5 8s2.4-4.2 6.5-4.2S14.5 8 14.5 8s-2.4 4.2-6.5 4.2S1.5 8 1.5 8Z" }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("circle", {
					cx: "8",
					cy: "8",
					r: "2.1"
				})]
		...
		function ExternalLinkIcon({ size = 13 }) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
				...
				strokeWidth: "1.3",
				"aria-hidden": "true",
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M6.5 3.5H3.8a1.3 1.3 0 0 0-1.3 1.3v7.4a1.3 1.3 0 0 0 1.3 1.3h7.4a1.3 1.3 0 0 0 1.3-1.3V9.5" }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M9.5 2.5h4v4M13.2 2.8 7.8 8.2" })]
			});
		}
		function VSCodeIcon({ size = 13 }) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("svg", {
				...
				fill: "currentColor",
				"aria-hidden": "true",
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M11.5 1.2 6.6 5.8 3.6 3.5 2 4.3l2.8 3.7L2 11.7l1.6.8 3-2.3 4.9 4.6 2.5-1.2V2.4l-2.5-1.2Zm.2 3.2v7.2L8.2 8l3.5-3.6Z" })
			});
		}
		function CloseIcon({ size = 12 }) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("svg", {
				...
				strokeWidth: "1.4",
				"aria-hidden": "true",
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "m3.5 3.5 9 9m0-9-9 9" })
			});
		}
		//#endregion
		...
		*/
		function FilePeek({ path, cwd, onClose, t }) {
			...
			if (state.kind === "loading") return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			...
			if (state.kind === "error") return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: file_peek_module_css_default.peek,
				"data-diff-stat-peek": "",
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					className: file_peek_module_css_default.bar,
			...
			if (state.kind === "binary") return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: file_peek_module_css_default.peek,
				"data-diff-stat-peek": "",
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					className: file_peek_module_css_default.bar,
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: [t("peek.bytes", { size: state.size }), state.truncated ? " · " + t("peek.truncated") : ""] }),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							type: "button",
							className: file_peek_module_css_default.close,
							"aria-label": closeLabel,
		...
		/**
		* Generated brand-logo path data for the file-type icons.
		* Source: Simple Icons v9 (https://simpleicons.org, CC0). Do not hand-edit;
		* regenerate from the downloaded svgs instead.
		*/
		...
		*/
		function FileTypeIcon({ path }) {
			...
			if (icon !== void 0 && d !== void 0) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("svg", {
				width: "14",
				height: "14",
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(FileSilhouette, { color: "var(--dsw-alias-label-tertiary)" });
		}
		//#endregion
		...
		*/
		function TurnCard({ matched, sessionId, openFile, getCwd, t }) {
			...
			const [peeked, setPeeked] = (0, react.useState)(() => /* @__PURE__ */ new Set());
			...
			const menuItems = (0, react.useMemo)(() => [
				{
					id: "peek",
					label: t("card.peek"),
					icon: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(EyeIcon, {})
				},
				{
					id: "open",
					label: t("card.openSystem"),
					icon: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ExternalLinkIcon, {})
				},
				...hostReady ? [{
					id: "explorer",
					label: t("card.showInExplorer"),
					icon: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconFolderOpen16, { size: 13 })
				}, {
					id: "vscode",
				...
				},
				{
					...
					icon: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconCopyOutline16, { size: 13 })
				},
				{
					id: "copy-rel",
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					...
					children: [
						...
						hostReady && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							type: "button",
					...
					children: matched.map((file) => {
						...
						return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
											...
											"aria-hidden": true,
											children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(FileTypeIcon, { path: file.path })
										}),
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
											type: "button",
												...
												children: [
													...
													/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Menu, {
														...
														anchor: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
															...
															children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronDownOutline14, { size: 11 })
														}),
														items: menuItems,
														onSelect: (id) => {
								...
								revealedFile && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									className: turn_card_module_css_default.diffWrap,
									children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(DiffWindow, {
										diffs: file.diffs,
										maxHeight: 320
									})
								}),
								peeked.has(file.path) && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(FilePeek, {
									path: file.path,
									cwd,
									t,
									onClose: () => {
