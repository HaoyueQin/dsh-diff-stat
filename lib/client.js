window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function MutationRow({ toolName, block, cwd, openFile, inspect }) {
			...
			const model = (0, react.useMemo)(() => rowModel(toolName, block, cwd), [
				toolName,
				block,
				cwd
			]);
		...
		function matchTurn(match) {
			...
			const direct = match.event.data.turn;
		...
		function TurnCard(props) {
			...
			const useSession = props.useChat ?? props.useSession;
			const [expanded, setExpanded] = (0, react.useState)(false);
			...
			const dispatchFiles = (0, react.useMemo)(() => {
				...
				if (chat === void 0) return EMPTY_FILES;
				const locations = chat.locations;
				const nodesStore = chat.nodes;
				if (locations === void 0 || nodesStore === void 0) return EMPTY_FILES;
					...
					children: allFiles.map((file) => {
						...
						return (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								revealedFile && preparedEntry !== void 0 && preparedEntry.input === file.diffs && preparedEntry.window !== null && (0, react_jsx_runtime.jsx)("div", {
		...
		function apply(ctx) {
			...
			const resolveRegistry = () => ctx.get("uiConversation")?.events ?? ctx.get("conversationEvents");
			...
			if (registry !== void 0) registry.register(snapshotFromStart(turnChangesDefinition));
			else {
